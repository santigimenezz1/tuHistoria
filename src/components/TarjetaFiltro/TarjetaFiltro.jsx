...
const TarjetaFiltro = ( {text, setEstadoCategoria, estadoCategoria, setFiltros, filtros, agregarFiltro = () =>console.log("solucion momentanea al error")} )=>{
 ...
 return (
  ...
  <label class="checkbox">
    <input onClick={()=>agregarFiltro(text)}  type="checkbox" />
